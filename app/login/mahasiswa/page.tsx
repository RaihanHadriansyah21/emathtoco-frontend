...
// Hanya izinkan redirect internal (path relatif diawali `/`, bukan `//` atau
// URL berskema lain) untuk mencegah open-redirect lewat query `redirect`.
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data?.session) {
        ...
        const targetPath = getSafeRedirectPath(searchParams.get("redirect"));
        ...
        try {
          ...
          if (
            ...
            !sessionStorage.getItem(sessionLoggedKey)
          ) {
            ...
            >
              <div className="flex items-center gap-2 min-w-0">
                ...
                <span className="text-[11px] font-medium leading-snug">
                  Server AI offline. Login tetap bisa, tapi fitur AI belum
                  tersedia.
                </span>
              </div>
              <button
              ...
              >
                <RefreshCw
                  className={`w-3.5 h-3.5 ${isRetryingBackend ? "animate-spin" : ""}`}
                />
              </button>
            </motion.div>
          )}
          ...
          >
            <div>
              <label
                ...
                className="block text-[10px] sm:text-xs font-bold uppercase tracking-widest text-neutral-400 mb-1.5 sm:mb-2"
              >
                Email
              </label>
              <input
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5 sm:mb-2">
                <label
                  ...
                  className="block text-[10px] sm:text-xs font-bold uppercase tracking-widest text-neutral-400"
                >
                  Password
                </label>
                <Link
                  href="/forgot-password"
                  className="text-[10px] sm:text-xs font-bold text-cyan-400 hover:text-cyan-300 hover:underline transition-all"
                >
                  Lupa Password?
                </Link>
              </div>
